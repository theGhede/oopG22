...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		// 3+ years old
		Animal animal1 = new Animal(2374, (int)(Math.random()*8367840+1576800), false, 0,
				(Math.random()*15+5), (Math.random()*9+1), true, (int)(Math.random()*3)+1);
		// 8+ years old
		Animal animal2 = new Animal(1743, (int)(Math.random()*5739840+4204800), true, (int)(Math.random()*1460+365),
				(Math.random()*15+5), 0, false, 0);
		// 3+ years old
		...
		// 3+ years old
		Animal animal4 = new Animal(1847, (int)(Math.random()*8367840+1576800), false, 0,
				(Math.random()*15+5), (Math.random()*9+1), true, (int)(Math.random()*5+1));
		// 3+ years old
		Animal animal5 = new Animal(3192, (int)(Math.random()*8367840+1576800), false, 0,
				(Math.random()*15+5), (Math.random()*9+1), false, 0);
		...
		// 3+ years old
		Animal animal6 = new Animal(1892, (int)(Math.random()*8367840+1576800), false, 0,
				(Math.random()*15+5), (Math.random()*9+1), false, 0);
		// 3+ years old
		Animal animal7 = new Animal(8904, (int)(Math.random()*8367840+1576800), false, 0,
				(Math.random()*15+5), (Math.random()*9+1), false, 0);
		...
		System.out.println("Printing an animal:");
		print(animal1);	
		System.out.println("\n The 2 packs:");
		packs.print();
